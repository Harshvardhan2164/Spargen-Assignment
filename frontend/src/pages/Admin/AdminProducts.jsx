...
//       setForm({ name: "", price: 0, brand: "", slug: "", rating: 0, stock: 0, tags: [], category: "", description: "" });
//       fetchProducts();
//     } catch {
...
//     try {
//       await API.put(`/product/update/${editForm._id}`, editForm);
...
//         <table className="w-full table-auto text-center bg-white dark:bg-gray-800 rounded shadow">
...
//             {loading ? (
//               <tr>
//                 <td colSpan="4" className="p-4 text-center">Loading products...</td>
//               </tr>
//             ) : products.length === 0 ? (
//               <tr>
...
//             ) : (
//               products.map((p) => (
//                 <tr key={p._id} className="hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-950">
//                   <td className="p-3 text-l">{p.name}</td>
//                   <td className="p-3 text-l">₹{p.price}</td>
//                   <td className="p-3 text-l">{p.category}</td>
//                   <td className="p-3 text-l flex gap-2 justify-center">
//                     <button
...
//         <Dialog.Panel className="bg-white dark:bg-gray-900 p-6 rounded shadow-lg w-full max-w-md">
