                            ...
                            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                                ...
                                <div className="mt-8">
                                    <a 
                                        ...
                                        className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-black bg-gray-300 hover:bg-primary-hover dark:text-white dark:bg-gray-900 dark:hover:bg-primary-dark-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                                    >
                                        Shop Now
